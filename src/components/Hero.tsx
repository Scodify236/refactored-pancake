      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center my-auto md:my-0 order-2 px-1 w-full pointer-events-none">
        ...
        <div className="flex flex-wrap items-center justify-center gap-2.5 mt-8 max-w-xl px-4 pointer-events-auto">
          {["Amazon", "Flipkart", "Roblox", "Overwatch 2", "League of Legends", "Sea of Thieves"].map((card) => (
            <span
              key={card}
              className="text-[10px] font-bold tracking-tight px-4 py-2 rounded-xl bg-card border border-border text-foreground shadow-sm hover:border-primary hover:bg-secondary transition-all duration-200 hover:scale-105 cursor-default"
            >
              {card}
            </span>
          ))}
      ...
      >
        <div className="flex flex-row items-center gap-3">
          ...
          <a
            ...
            className="relative inline-flex h-11 md:h-13 items-center justify-center gap-2 rounded-xl bg-primary px-6 md:px-10 text-xs md:text-sm font-bold text-primary-foreground shadow-lg transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] cursor-pointer"
          >
          ...
          <a
            href="#brands"
            className="relative inline-flex h-11 md:h-13 items-center justify-center gap-2 rounded-xl bg-card px-6 md:px-8 text-xs md:text-sm font-bold text-card-foreground shadow-sm ring-1 ring-border transition-all duration-200 hover:bg-secondary active:scale-[0.98] cursor-pointer"
          >
